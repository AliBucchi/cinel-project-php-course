...
if(isset($_POST['registar'])){
    $src=$_FILES['src']['name']; # nome do ficheiro
    $tempFile=$_FILES['src']['tmp_name'];
    # $fileSize=$_FILES['src']['size']/1024; 
    #identificar a extensão para multiplos propositos
    $extensao=pathinfo($src,PATHINFO_EXTENSION);
    $src=base64_encode($src); # codificação completa sem extensão    
    $data=date("ymdhis");
    $src=$src.$data.".".$extensao;
    $src="assets/img/avatars/".$src; # ainda não garante ficheiros únicos 
    $table="imagem";
    $sql="INSERT INTO $table VALUES (NULL, '$src')";
    mysqli_query(CONNECT, $sql);
    move_uploaded_file($tempFile,$src);
    header("Location:?ficheroEnviado");
}
?>
...
<head>
    ...
    <title>Blank Page - Turma62</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Turma62</span></div>
                </a>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="ufcd.html"><i class="fas fa-table"></i><span>UFCDs</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Upload de imagens</h3>
<form method="POST" enctype="multipart/form-data">
<input type="file" name="src">
<input type="submit" value="Enviar ficheiro" name="registar">
</form>
